...
Here the test_case_using_v2 within test_service_config.py merely fails due to the new default parameter value of max_worker_threads field in the ServiceConfig message in the interface definitions in interfaces. See the v1 and v2 interface definitions in interfaces directory to see this new default parameter value being defined.
